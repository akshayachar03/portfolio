...
import React from "react";
import { motion } from "framer-motion";
import { Code, Briefcase, GraduationCap, User, Server, Settings, Package2, Package, CloudCog } from "lucide-react";
import profileImage from "../assets/Akshay-Profile.png";
    ...
    >
      <div className="container mx-auto">
        ...
        >
          ...
          <div className="w-20 h-1 bg-purple-600 mx-auto mb-6"></div>
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            A glimpse into my background, skills, and passion for DevOps.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          >
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white">
            I'm a passionate DevOps Engineer with a focus on building scalable and efficient infrastructure.
            </h3>
            <p className="text-gray-600 dark:text-gray-400">
            With a strong foundation in automation, cloud computing, and CI/CD pipelines, 
             I specialize in streamlining development workflows 
            and improving system reliability. My skill set includes Linux,
            Docker, Kubernetes, Terraform, Ansible, Jenkins, Git, AWS, and Azure, enabling me to 
            deploy and manage robust cloud-native applications.
          
            </p>
            <p className="text-gray-600 dark:text-gray-400">
            I thrive on solving complex challenges through automation and continuous improvement. Always eager to learn, 
            I stay updated with the latest DevOps tools and best practices to drive innovation and efficiency in software delivery. 🚀
            </p>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              <div className="flex items-center space-x-2">
                <CloudCog size={20} className="text-purple-600" />
                <span className="text-gray-700 dark:text-gray-300">
